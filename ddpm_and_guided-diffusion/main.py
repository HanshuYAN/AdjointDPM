#!/home/tiger/miniconda3/envs/diff/bin/python3
...
def parse_args_and_config():
    ...
    parser.add_argument("--attack", action="store_true", help="Whether to attack the model")
    parser.add_argument(
        "--sample",
        action="store_true",
    ...
    parser.add_argument("--num_samples",type=int, default=30, help="number of samples to be attacked")
    parser.add_argument("--attack_batch_size", type=int, default=10, help="batch size for one attack")
    parser.add_argument("--nb_iter", type=int, default=30, help="number of iterations to attack")
    parser.add_argument("--lr", type=float, default=0.01, help="updating rate for attack the initial noise")
    parser.add_argument("--clamp_min", type=float, default=0.1, help="lower bound to clamp the gradients")
    parser.add_argument("--clamp_max", type=float, default=0.1, help="upper bound to clamp the gradients")
    ...
    if not args.test and not args.sample and not args.attack:
        ...
        if args.sample or args.test or args.attack:
